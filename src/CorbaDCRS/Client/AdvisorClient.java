...
public class AdvisorClient extends Client {
    ...
    public void startAdvisorClient(DCRS servent , String AdvisorId) throws RemoteException {
        ...
        while(true){
            ...
            switch(cmd) {
                ...
                case "3" :
                    System.out.println("Input the semester");
                    semester = sc.nextLine();
                    String[] courseAvailability = servent.listCourseAvailability(semester);
                ...
                case "6" :
                    System.out.println("Input The Student Id: ");
                    studendId = sc.nextLine();
                    String[] classSchedule = servent.getClassSchedule(studendId);
                ...
                case "7" :
                    ...
                    result = servent.swapCourse(studendId, newCourseId, oldCourseId);
                    logger.info("Operation: " + result);
                    break;
                default :
    ...
    public static void main(String[] args) throws RemoteException{
        ...
        DCRS servent = advisorClient.Login();
        if (servent != null){
