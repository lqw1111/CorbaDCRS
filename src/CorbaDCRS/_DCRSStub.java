...
/**
* CorbaDCRS/_DCRSStub.java .
* 由IDL-to-Java 编译器 (可移植), 版本 "3.2"生成
* 从CorbaDCRS.idl
* 2018年10月24日 星期三 下午02时53分47秒 EDT
*/

public class _DCRSStub extends org.omg.CORBA.portable.ObjectImpl implements CorbaDCRS.DCRS
{
  ...
  public String[] listCourseAvailability (String semester)
  {
            ...
            try {
                ...
                $out.write_string (semester);
                $in = _invoke ($out);
                String $result[] = CorbaDCRS.listHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
